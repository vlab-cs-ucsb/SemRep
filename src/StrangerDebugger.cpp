...
unsigned char DEBUG_ENABLED_LB = DEBUG_LEVEL_WRAPPER & DEBUG_MASK_LENGTH_BACKWARD;
unsigned char DEBUG_ENABLED_LF = DEBUG_LEVEL_WRAPPER & DEBUG_MASK_LENGTH_FORWARD;
unsigned char DEBUG_ENABLED_LAB = DEBUG_LEVEL_WRAPPER & DEBUG_MASK_LAST_BACKWARD;
