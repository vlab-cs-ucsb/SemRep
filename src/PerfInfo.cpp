...
void PerfInfo::print_operations_info() {
	...
	cout << "\t pre_concat : #" << num_of_pre_concat << " : " << pre_concat_total_time << " (" << pre_concat_total_time.total_milliseconds() << " ms)" << endl;
	cout << "\t const_pre_concat : #" << num_of_const_pre_concat << " : " << const_pre_concat_total_time << " (" << const_pre_concat_total_time.total_milliseconds() << " ms)" << endl;
	cout << "\t replace : #" << num_of_replace << " : " << replace_total_time << " (" << replace_total_time.total_milliseconds() << " ms)" << endl;
	cout << "\t pre_replace : #" << num_of_pre_replace << " : " << pre_replace_total_time << " (" << pre_replace_total_time.total_milliseconds() << " ms)" << endl;
	cout << "\t vlab_restrict : #" << number_of_vlab_restrict << " : " << vlab_restrict_total_time << " (" << vlab_restrict_total_time.total_milliseconds() << " ms)" << endl;
	cout << "\t pre_vlab_restrict : #" << number_of_pre_vlab_restrict << " : " << pre_vlab_restrict_total_time << " (" << pre_vlab_restrict_total_time.total_milliseconds() << " ms)" << endl;
	cout << "\t addslahses : #" << number_of_addslashes << " : " << addslashes_total_time << " (" << addslashes_total_time.total_milliseconds() << " ms)" << endl;
	cout << "\t pre_addslahses : #" << number_of_pre_addslashes << " : " << pre_addslashes_total_time << " (" << pre_addslashes_total_time.total_milliseconds() << " ms)" << endl;
	...
	cout << "\t pre_htmlspecialchars : #" << number_of_pre_htmlspecialchars << " : " << pre_htmlspecialchars_total_time << " (" << pre_htmlspecialchars_total_time.total_milliseconds() << " ms)" << endl;
	cout << "\t stripslashes : #" << number_of_stripslashes << " : " << stripslashes_total_time << " (" << stripslashes_total_time.total_milliseconds() << " ms)" << endl;
	cout << "\t pre_stripslashes : #" << number_of_pre_stripslashes << " : " << pre_stripslashes_total_time << " (" << pre_stripslashes_total_time.total_milliseconds() << " ms)" << endl;
	...
	cout << "\t pre_mysql_escape_string : #" << number_of_pre_mysql_escape_string << " : " << pre_mysql_escape_string_total_time << " (" << pre_mysql_escape_string_total_time.total_milliseconds() << " ms)" << endl;
	cout << "\t to_uppercase : #" << number_of_to_uppercase << " : " << to_uppercase_total_time << " (" << to_uppercase_total_time.total_milliseconds() << " ms)" << endl;
	cout << "\t pre_to_uppercase : #" << number_of_pre_to_uppercase << " : " << pre_to_uppercase_total_time << " (" << pre_to_uppercase_total_time.total_milliseconds() << " ms)" << endl;
	cout << "\t to_lowercase : #" << number_of_to_lowercase << " : " << to_lowercase_total_time << " (" << to_lowercase_total_time.total_milliseconds() << " ms)" << endl;
	cout << "\t pre_to_lowercase : #" << number_of_pre_to_lowercase << " : " << pre_to_lowercase_total_time << " (" << pre_to_lowercase_total_time.total_milliseconds() << " ms)" << endl;
